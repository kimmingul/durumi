...
const SHORTCUTS: Group[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { keys: ['Cmd/Ctrl', 'Shift', '1'], labelKey: 'menu.view.editMode.wysiwyg' },
      { keys: ['Cmd/Ctrl', 'Shift', '2'], labelKey: 'menu.view.editMode.typora' },
      { keys: ['Cmd/Ctrl', 'Shift', '3'], labelKey: 'menu.view.editMode.markdown' },
