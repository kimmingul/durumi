...
export const menuLabels: Record<MenuLang, Record<string, string>> = {
  en: {
    ...
    'menu.file.refreshProjectTree': 'Refresh Project Tree',
    ...
    'menu.file.openRecentFolder': 'Open Recent Folder',
    'menu.file.noRecentFolders': 'No recent folders',
    'menu.file.save': 'Save',
    ...
    'menu.view.splitPanel': 'Split Panel',
    'menu.view.closePanel': 'Close Panel',
  ...
  ko: {
    ...
    'menu.view.splitPanel': '패널 분할',
    'menu.view.closePanel': '패널 닫기',
