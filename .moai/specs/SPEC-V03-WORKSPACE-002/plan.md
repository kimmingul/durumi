...
### §A.2 결정 로그 — **확정 4건 (OQ-1·2·5·6)** / 미해결 6건 (OQ-3·4·7·8·9·10)
...
**M1~M2·M6~M7은 이제 차단 해제되었다** — OQ-1(레이아웃)·OQ-2(상태 소유)·OQ-5(pathGuard)·OQ-6(저장 경로 + EOL)이 확정되었다. 남은 미해결 6건의 시점은 아래와 같다.
