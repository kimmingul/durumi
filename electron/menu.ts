  ...
  const template: MenuItemConstructorOptions[] = [
    ...
    },
    {
      ...
      submenu: [
        ...
        { type: 'separator' as const },
        { label: tr('menu.view.splitPanel'), accelerator: 'CommandOrControl+Alt+\\', click: () => send('splitPanel') },
        { label: tr('menu.view.closePanel'), accelerator: 'CommandOrControl+Alt+W', click: () => send('closePanel') },
        { type: 'separator' as const },
    ...
    },
    {
      ...
      submenu: [
        ...
        { type: 'separator' },
        {
          label: tr('menu.review.showReferences'),
          click: () => send('showReferences'),
        },
      ],
    },
    {
      label: tr('menu.aiAssist'),
      submenu: [
        {
